package com.example.wayangapp.wayangcamera
...
import com.example.wayangapp.databinding.ActivityWayangCameraBinding
import com.example.wayangapp.ml.FinalTrain
...
class WayangCameraActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 250 && data != null) {
            ...
            val model = FinalTrain.newInstance(this)
            ...
            val inputFeature0 = //menyimpan gambar resize
                TensorBuffer.createFixedSize(intArrayOf(1, 224, 224, 3), DataType.FLOAT32)
            inputFeature0.loadBuffer(byteBuffer)

            val outputs = model.process(inputFeature0) //menggunakan model.process untuk klasifikasi
            val outputFeature0 = outputs.outputFeature0AsTensorBuffer //menyimpan nilai probabilitas klasifikasi
            ...
            binding.ivImagePreview.setImageResource(R.drawable.m_tidak_ada_gambar)
            binding.cardKrucil.visibility = View.GONE
            binding.cardGedog.visibility = View.GONE
            binding.cardSuluh.visibility = View.GONE
            binding.cardKulit.visibility = View.GONE
            ...
            Toast.makeText(
                this,
                "Ambil/Pilih Gambar Terlebih Dahulu",
                Toast.LENGTH_SHORT
            ).show()
        }
    }
